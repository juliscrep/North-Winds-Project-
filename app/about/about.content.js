...
a mantener la excelencia en la prestación de nuestros servicios en el sector de energía renovable.`,
};

export const certificationText = {
  title: "Certificaciones",
  paragraph1: `Hemos obtenido la certificación del Wind Training Center (WTC). 
...
mercado cada vez más exigente.`,
  ...
  paragraph2: `En North Winds, consideramos que esta certificación es un testimonio de nuestra misión de proporcionar 
...
equipo certificado y comprometido con la excelencia.`,
  ...
  paragraph3: `También, hemos obtenido la certificación de la cesta de elevación para el 
...
export const certificationPDFs = [
  "/img/certificado1.pdf",
  "/img/certificado2.pdf",
...
export const inspectionDocs = [
  { pdf: "/img/InformeInspeccion.pdf", image: "/img/informe.png" },
  { pdf: "/img/CertificadoInspeccion.pdf", image: "/img/fotoInspeccion.png" },
];

export const inspection2025Docs = [
  { pdf: "/img/INFORME2025.pdf", image: "/img/informe2025.png" },
  { pdf: "/img/inspeccion2025.pdf", image: "/img/inspeccion2025.png" },
];
